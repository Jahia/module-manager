...
<ul class="nav nav-tabs" id="availableModuleTabs" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link active" id="available-modules-tab" data-toggle="tab" href="#available-modules" role="tab"
    ...
    <input type="hidden" name="_eventId" value="reloadModules"/>
         ...
         <span class="refreshModule">
            <button  data-toggle="tooltip" data-placement="bottom" title="${i18nModuleRefresh}" data-container="body" data-original-title="${i18nModuleRefresh}"
