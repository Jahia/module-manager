 ...
 */
@XmlType
public class ClusterNodesPostParam {
  ...
  public ClusterNodesPostParam( @DefaultValue("") @PathParam("nodes") String nodesAsPathParam) {
  ...
  public Set<String> getNodesSet(){
    ...
    // - resolve from form but is should be the same as query
